...
###                 Plots                     ###
###############   PROTOES   ###############
VdG_Plot('0123/RBS1run01.dat', 'Calib Ta-V-Nb - 8 mm') # Calibration V-Ta-Nb
VdG_Plot_logy('0123/RBS1run02.dat', 'Calib Ta-V-Nb - 9 mm') # Calibration V-Ta-Nb    

VdG_Plot_logy('0123/RBS1run03.dat', 'target 4 - 20 mm') # Target 4 - no cleaning
VdG_Plot_logy('0123/RBS1run04.dat', 'target 4 - 22 mm') # Target 4 - no cleaning

VdG_Plot_logy('0123/RBS1run05.dat', 'target 5 - 33 mm') # Target 5 - 1 dip
VdG_Plot_logy('0123/RBS1run06.dat', 'target 5 - 35 mm') # Target 5 - 1 dip

VdG_Plot_logy('0123/RBS1run07.dat', 'target 6 - 44 mm') # Target 6 - 2 dips
VdG_Plot_logy('0123/RBS1run08.dat', 'target 6 - 46 mm') # Target 6 - 2 dips

VdG_Plot_logy('0123/RBS1run09.dat', 'target 7 - 56 mm') # Target 7 - 3 dips
VdG_Plot_logy('0123/RBS1run10.dat', 'target 7 - 58 mm') # Target 7 - 3 dips

VdG_Plot_logy('0123/RBS1run11.dat', 'target 1 - 15 mm') # Target 1 
VdG_Plot_logy('0123/RBS1run12.dat', 'target 1 - 20 mm') # Target 1 
VdG_Plot_logy('0123/RBS1run13.dat', 'target 1 - 20 mm') # Target 1 

VdG_Plot_logy('0123/RBS1run14.dat', 'target 2 - 55 mm') # Target 2
VdG_Plot_logy('0123/RBS1run15.dat', 'target 2 - 60 mm') # Target 2 

VdG_Plot_logy('0123/RBS1run16.dat', 'target E2 - 15 mm') # Target E2 
VdG_Plot_logy('0123/RBS1run17.dat', 'target E2 - 20 mm') # Target E2
VdG_Plot_logy('0123/RBS1run18.dat', 'target E2 - 20 mm - 180º') # Target E2 - 180º
