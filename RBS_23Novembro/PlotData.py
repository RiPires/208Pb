...
VdG_Plot('1122/alfas/ERDrun2.dat', 'ERD: target 1 - 21 mm') ## Target 1 - large hole


VdG_Plot('1122/alfas/RBS1run3.dat', 'RBS1: target 1 - 23 mm') ## Target 1 - large hole
VdG_Plot('1122/alfas/RBS2run3.dat', 'RBS2: target 1 - 23 mm') ## Target 1 - large hole
VdG_Plot('1122/alfas/ERDrun3.dat', 'ERD: target 1 - 23 mm') ## Target 1 - large hole


VdG_Plot('1122/alfas/RBS1run4.dat', 'target 1 - 25 mm') ## Target 1 - large hole

VdG_Plot('1122/alfas/RBS1run5.dat', 'RBS1: target 1 - 27 mm') ## Target 1 - large hole
VdG_Plot('1122/alfas/RBS2run5.dat', 'RBS2: target 1 - 27 mm') ## Target 1 - large hole
VdG_Plot('1122/alfas/ERDrun5.dat', 'ERD: target 1 - 27 mm') ## Target 1 - large hole
